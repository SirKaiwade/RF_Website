...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        card: '0 1px 0 rgba(26, 31, 44, 0.04), 0 1px 3px rgba(26, 31, 44, 0.06)',
        elevated: '0 8px 24px rgba(26, 31, 44, 0.08), 0 2px 6px rgba(26, 31, 44, 0.04)',
        panel: '0 12px 32px rgba(26, 31, 44, 0.12), 0 2px 8px rgba(26, 31, 44, 0.06)',
